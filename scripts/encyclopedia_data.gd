...
const ENTRIES: Array[Dictionary] = [
	...
	},
	{
		"id": "tree_counter",
		"category": "UPGRADES",
		"name": "绝地反击流派 (Counter Vanguard Tree)",
		"tag": "精准盾反 / 升阶逆转",
		"icon": "res://assets/sprites/tanks/player_counter_t2_f0.png",
		"stats": {
			"Tier 1 绝地反击先锋": "开火部署能量偏折盾，0.14s 完美窗口弹反升阶敌弹破钢，攻速极慢 (~1.15s)",
			"Tier 2 超导破阵要塞": "弹反窗口宽至 0.18s，蓄力反冲炮，拦截敌方激光触发三向棱镜全反射！",
			"流派核心优势": "高风险极高收益的攻防转换，精准弹反完全免疫伤害并反制秒杀敌人"
		},
		"desc": "配备能量反冲发生器与高周波反弹盾的战术反击型战车。主炮攻速极慢，但每次开火前沿形成短暂能量盾，成功弹反敌方炮弹可升阶为穿透破钢弹并重置冷却，更能将敌方激光折射返还！",
		"tactics": "切忌盲目连点开火！务必卡准敌方炮弹逼近的刹那发动开火盾反。完美盾反不仅返还冷却并强化子弹，还能立刻蓄力下一发破钢重炮，在敌阵弹幕中实现无伤反杀。"
	},
	{
		"id": "tree_trench",
		"category": "UPGRADES",
		"name": "壕沟战流派 (Trench Warfare Tree)",
		"tag": "环形激光切割 / 削弹碎壁",
		"icon": "res://assets/sprites/tanks/player_trench_t2_f0.png",
		"stats": {
			"Tier 1 壕沟先锋型": "发射前方短距离环形激光锯刃 (半径 42px)，切割来袭敌弹并粉碎常规砖块，生命 +2 HP",
			"Tier 2 超导破阵战壕堡垒": "激光切割环半径扩至 54px，直接粉碎钢铁工事与防御要塞，切割伤害 +3，生命 +4 HP",
			"流派核心优势": "刀光护体拦截敌方弹道 + 攻防一体强拆敌方工事掩体"
		},
		"desc": "搭载前装式高频环形激光切割发生器的阵地突破型战车。每次开火向前方展开高速旋转的高能等离子环刃，不仅能对前方短距离敌军造成高频切割伤害，更具备与当前炮弹破坏等级相同的断金削弹能力！",
		"tactics": "面对敌方密集的交叉火力或据守钢墙时，利用激光环刀迎头切爆敌弹并推进。升至 2 阶后可直接连人带钢墙一并斩断！"
	},
	{
	...
	{
		"id": "perk_kinetic_piston_rounds",
		"category": "UPGRADES",
		"name": "活塞冲压弹 (Kinetic Piston Rounds)",
		"tag": "动能推移 / 挤压处决",
		"icon": "res://assets/sprites/powerups/piston_rounds.png",
		"stats": {
			"动能推移": "命中墙体/建筑向前暴击推移 1 格",
			"破坏门禁": "普通弹可推砖/木/普通建筑，破钢弹可推重钢墙",
			"挤压处决": "若敌军被两面墙体夹击，触发 999 毁灭秒杀！"
		},
		"desc": "主炮换装特制高冲量液压冲压弹头。炮弹蕴含庞大动能，命中阻挡方块或建筑物时会将其暴力撞退推进！可以推动的方块类型严格与炮弹破坏等级绑定。更可怕的是，当推移的障碍物将敌人逼入死角、两面受力挤压时，将瞬间造成粉碎性处决！",
		"tactics": "利用敌军背靠钢铁外墙或转角的站位开炮推墙，触发两墙合围瞬间粉碎秒杀血量再厚的敌人！"
	},
	{
	...
	},
	{
		...
		"desc": "战役模式中没有经验条 —— 战车升级只有一个入口：拾取战场上的 ⭐ 星形道具 (STAR)，吃到一颗即升一级，不设门槛。各项战术指标按硬核平衡曲线自动成长升级，确保每一级都带来清晰可感知的战力增幅。",
		"tactics": "优先保护基地老鹰与优先争夺场上的 ⭐ 星形道具，前 3 级尽快升出第 1 点攻击力以确保在后续楼层具备一发秒杀常规杂兵的能力。"
	},
	...
	},
	{
		"id": "player_counter",
		"category": "TANKS",
		"name": "绝地反击战车 (Counter Vanguard)",
		"tag": "友方分支 / 盾反逆转",
		"icon": "res://assets/sprites/tanks/player_counter_t1_f0.png",
		"stats": {
			"基础生命": "5~9 HP (厚实承伤)",
			"机动移速": "125 px/s (标准)",
			"主炮射速": "极慢 (~1.15s 充能反冲)",
			"专属优势": "开火生成瞬态反冲盾，完美判定下反弹敌弹升阶并全反射敌方激光"
		},
		"desc": "前沿加载反冲反应装甲与高能折射盾的战备核心。虽然主炮开火周期极慢，但拥有将敌方一切攻击化为己用的致命反击机制。",
		"tactics": "敌方弹幕越密集，反击坦克的威力和反打空间越大。把握好弹反时机，即可在枪林弹雨中以敌人的炮火撕碎敌人自身。"
	},
	{
		"id": "player_trench",
		"category": "TANKS",
		"name": "战壕切割坦克 (Trench Cutter)",
		"tag": "友方分支 / 激光环切",
		"icon": "res://assets/sprites/tanks/player_trench_t1_f0.png",
		"stats": {
			"基础生命": "5~9 HP (强化阵地装甲)",
			"机动移速": "125 px/s (标准)",
			"主武器": "前方环形激光切割刀弧 (短距范围切割)",
			"专属优势": "主动消解切割一切接触的敌方炮弹，切割等级随炮弹进阶破钢"
		},
		"desc": "专门用于壕沟战与阵地突破的重装工程攻击车。装备高能弧形电浆切割器，能够在近战中轻易切开敌阵与任何拦截的投射物。",
		"tactics": "适合喜欢近身肉搏和撕裂敌方密集弹幕的指挥官。保持贴近交火线，用环刀瓦解敌方输出节奏。"
	},
	{
		"id": "enemy_basic",
		"category": "TANKS",
	...
	},
	{
		"id": "enemy_bulldozer",
		"category": "TANKS",
		"name": "冲压推土机 (The Bulldozer / Rammer)",
		"tag": "特种敌军 / 强推墙体 / 挤压处决",
		"icon": "res://assets/sprites/tanks/enemy_bulldozer_f0.png",
		"stats": {
			"生命值": "8 HP (重型工程装甲)",
			"移速": "52 px/s (稳定强推推进)",
			"推进装备": "液压推土强力巨铲 + 冲压炮",
			"挤压特性": "推墙夹击造成 3 点重伤与 2 秒僵直",
			"威胁等级": "★★★★☆"
		},
		"desc": "装配重型液压推土铲的工程冲撞战车。正面推进时会将一切拦路的建筑与墙体向前猛力推移！当玩家或友方掩体被其推移的墙体挤压逼入死角（后方为硬墙或边界）时，会遭受极度致命的两墙挤压伤害！同时它还会偶尔发射推移炮弹阻断你的走位。",
		"tactics": "千万不要背靠硬墙或站在狭窄死角！时刻保持活动走位，避免被其正面冲推挤压在墙壁之间。"
	},
	{
		"id": "enemy_cannon",
		"category": "TANKS",
		"name": "巨炮要塞战车 (Colossus Siege Tank)",
		"tag": "近距变形 / 固定要塞炮 / 极高防御",
		"icon": "res://assets/sprites/tanks/enemy_cannon_f0.png",
		"stats": {
			"生命值": "6 HP (重型铸造钢甲)",
			"移速": "65 px/s (巡航) / 0 px/s (驻扎)",
			"特殊能力": "近距变形驻扎 (四角驻锄抓地+防盾前展)",
			"驻扎防御": "受到伤害大幅减免 65% (单次受击伤害极低)",
			"主武器": "重型攻城榴弹炮 (驻扎时发射 2伤+54px AoE 破钢弹)",
			"威胁等级": "★★★★★"
		},
		"desc": "搭载巨型重榴弹攻城主炮与折叠液压驻锄的重型压制作战车。在远距离以平稳履带巡航；一旦接近玩家战车（4格内），会立刻展开四角重型液压地钉深深咬入地面，并将两侧防弹重盾向前合拢构成坚不可摧的半包围碉堡要塞，防御力飙升并倾泻大范围高爆攻城破钢重弹！",
		"tactics": "切忌在开阔地带与其正面对轰！在它变形驻扎后利用高机动性绕开正面防盾死角，或利用等离子破钢武器、定时炸弹与空袭在其侧后方进行破防打击。"
	},
	{
	...
	},
	{
		...
		"stats": {
			"生命值": "3 HP",
			"移速": "65 px/s",
			"武器机制": "停步蓄力约1.2秒(显示充能格数)后发射穿透全场的聚能光束",
			"威胁等级": "★★★★☆"
		},
		"desc": "装备聚能激光发射器的高科技战车，开火前会停下车身、锁定方向并蓄力，车顶浮现一排充能格数指示器；蓄满后激光沿锁定方向瞬间穿透一整列障碍物并击穿多辆坦克。",
		"tactics": "看到车顶格数指示器开始点亮，就是它已经锁定了开火方向——趁蓄力的这段时间走出那条直线，不要等格数点满才反应；同时不要与多名队友或基地处在同一条水平/垂直直线上。"
	},
	{
		"id": "enemy_missile",
		"category": "TANKS",
	...
	},
	{
		"id": "enemy_firewall",
		"category": "TANKS",
		"name": "火墙重型战车 (Firewall Tank)",
		"tag": "区域封锁 / 烈焰轨迹",
		"icon": "res://assets/sprites/tanks/enemy_firewall_f0.png",
		"stats": {
			"生命值": "4 HP (耐热黑曜装甲)",
			"移速": "78 px/s (持续压迫机动)",
			"特殊能力": "身后留存 10 格烈焰火墙轨迹 (触碰灼烧伤害)",
			"主武器": "重型高压喷火巨炮 (2.0s 射速)",
			"威胁等级": "★★★★☆"
		},
		"desc": "车尾搭载双联重油凝固汽油点火喷槽的区域封锁战车。在行进过程中会在身后持续铺设长达 10 格的熊熊燃烧火墙轨迹，任何敌对目标触碰或驶入火墙区域都将受到灼烧伤害，能够极大地封锁走位并切割战场。",
		"tactics": "切勿跟随在其车尾或盲目穿越其烈焰封锁线！利用远程火炮在其前方或侧翼进行拦截打击。"
	},
	{
		"id": "enemy_hunter",
		"category": "TANKS",
		"name": "丛林猎手坦克 (Hunter Ambush Tank)",
		"tag": "草丛潜伏 / 致命伏击",
		"icon": "res://assets/sprites/tanks/enemy_hunter_f0.png",
		"stats": {
			"生命值": "2 HP (隐蔽战术轻甲)",
			"移速": "88 px/s (敏捷潜行转移)",
			"特殊能力": "草丛半透明伪装潜伏 (路过突袭射击)",
			"主武器": "消音长身管穿甲狙击炮 (1.8s 射速)",
			"威胁等级": "★★★☆☆"
		},
		"desc": "搭载折叠迷彩伪装网架与战术红外潜望镜的伏击特化坦克。在战场上会优先导航进驻最近的丛林草丛，进入半透明静止潜伏状态；当玩家经过草丛视野时会瞬间破隐发动致命突袭；在无草丛地图则执行常规游走巡逻。",
		"tactics": "路过茂密草丛时切勿大意！可利用探路炮火提前轰击草丛盲区，或使用炸药、火炮摧毁草丛使其失去隐蔽庇护。"
	},
	{
		"id": "enemy_sandworm",
		"category": "TANKS",
		"name": "沙虫潜地战车 (Sandworm Dune Tank)",
		"tag": "潜地避弹 / 随机破土突袭",
		"icon": "res://assets/sprites/tanks/enemy_sandworm_f0.png",
		"stats": {
			"生命值": "3 HP (几丁质分段甲)",
			"移速": "72 px/s (地面蠕动巡逻)",
			"特殊能力": "周期性潜入地下 (避弹转移+随机破土)",
			"主武器": "背负式双联沙爆迫击炮 (2.0s 射速)",
			"威胁等级": "★★★★☆"
		},
		"desc": "车头搭载硬岩旋风巨钻与几丁质分段式甲壳的特殊潜地战车。每隔数秒会缩入地下潜行并规避常规火力打击，随后在战场随机空地（尤其是玩家周围）伴随冲击波破土冲出并立即发动突袭射击。",
		"tactics": "当其潜入地下时切勿站立不动！密切观察地面出现的扬尘预警圈，在其破土冲出的瞬间预判火力进行集火反击。"
	},
	{
		"id": "enemy_tesla",
		"category": "TANKS",
		"name": "特斯拉电弧磁暴战车 (Tesla Tank)",
		"tag": "战术控场 / 连锁放电",
		"icon": "res://assets/sprites/tanks/enemy_tesla_f0.png",
		"stats": {
			"生命值": "4 HP",
			"移速": "70 px/s",
			"主武器": "双联高压电弧放电线圈 (480 px/s 高速雷电弹)",
			"被动机制": "受击时释放静电防卫火花，阻断近身突击",
			"威胁等级": "★★★★☆"
		},
		"desc": "搭载双特斯拉放电线圈与重型储能电容的高科技电磁战车。主炮发射极速高压等离子电弧，在战场上具备极强的命中率与穿透压制力。",
		"tactics": "其弹道初速极高，切勿在开阔地带与其进行超远距离对枪；建议借助掩体进行闪身开火打击。"
	},
	{
		"id": "enemy_toxic",
		"category": "TANKS",
		"name": "剧毒生化布雷车 (Toxic Spreader)",
		"tag": "区域封锁 / 酸液腐蚀",
		"icon": "res://assets/sprites/tanks/enemy_toxic_f0.png",
		"stats": {
			"生命值": "3 HP",
			"移速": "76 px/s",
			"主武器": "双管生化酸液发射器 (发射强腐蚀酸液泥弹)",
			"区域机制": "命中爆裂释放大范围生化剧毒酸雾飞溅",
			"威胁等级": "★★★★☆"
		},
		"desc": "配备三联加压生化储液罐与前方化学喷嘴的区域压制战车。向目标区域倾泻高腐蚀性化学毒泥，造成强烈的范围污染与阻滞效果。",
		"tactics": "切忌站在其生化毒泥飞溅半径内；利用其中等射程的弱点保持中距离快速击破。"
	},
	{
		"id": "enemy_drone_carrier",
		"category": "TANKS",
		"name": "蜂巢无人机航母战车 (Drone Carrier)",
		"tag": "战术母舰 / 蜂群召唤",
		"icon": "res://assets/sprites/tanks/enemy_drone_carrier_f0.png",
		"stats": {
			"生命值": "8 HP (重装移动机库)",
			"移速": "52 px/s",
			"核心能力": "背部蜂巢机库周期性弹射自爆轻型无人机",
			"自卫武器": "前方速射防御机枪 (440 px/s)",
			"威胁等级": "★★★★★"
		},
		"desc": "六角装甲底盘的重型战术无人机母舰。本身具备坚固装甲，背部自动升降机库会源源不断弹射自爆无人机执行自杀式突袭，是战场上极度棘手的战术核心。",
		"tactics": "发现航母后应将其列为第一优先击杀目标！若放任其持续弹射无人机，极易形成蜂群包夹压制。"
	},
	{
		"id": "enemy_drone_mini",
		"category": "TANKS",
		"name": "四旋翼自爆轻型无人机 (Assault Mini Drone)",
		"tag": "空中突袭 / 接触自爆",
		"icon": "res://assets/sprites/tanks/enemy_drone_mini_f0.png",
		"stats": {
			"生命值": "1 HP (轻量化机身)",
			"移速": "115 px/s (空中全向高速追踪)",
			"攻击机制": "无视地形直扑目标，近身或受损时即刻自爆",
			"威胁等级": "★★★☆☆"
		},
		"desc": "由蜂巢航母战车弹射的四旋翼轻型突击无人机。具备极高的全向空中机动性，接触任何目标或掩体时会瞬间引爆腹部高爆炸药。",
		"tactics": "血量极低，在它们高速逼近前使用任意子弹或范围武器提前引爆即可安全化解危机。"
	},
	{
		"id": "enemy_trench",
		"category": "TANKS",
		"name": "战壕突击战车 (Trench Breaker)",
		"tag": "近战切割 / 截断弹道",
		"icon": "res://assets/sprites/tanks/enemy_trench_f0.png",
		"stats": {
			"生命值": "4 HP (加固战壕前甲)",
			"移速": "72 px/s (步步为营推进)",
			"特殊能力": "前方释放高能激光环切刀刃",
			"拦截机制": "激光环可瞬间切碎玩家来袭炮弹并粉碎沿途掩体",
			"威胁等级": "★★★★☆"
		},
		"desc": "装备战术激光切割弧刃的特种突击坦克。在阵地战中会向玩家推进并周期性挥出环形等离子刃，摧毁玩家子弹的同时粉碎周边砖石掩体。",
		"tactics": "与其交火时切忌直线连续单发对射，否则子弹极易被其环刃正面切碎；建议拉开距离在其环刃冷却期攻击，或从侧翼夹击弱点。"
	},
	{
		"id": "enemy_boss",
		"category": "TANKS",
	...
	},
	{
		"id": "enemy_titan_boss",
		"category": "TANKS",
		"name": "无畏战列泰坦 (Dreadnought Titan)",
		"tag": "终极首领 / 等离子核能",
		"icon": "res://assets/sprites/tanks/enemy_titan_boss_f0.png",
		"stats": {
			"生命值": "16~30 HP (四履带重装护甲)",
			"移速": "46 px/s (重装泰坦缓行)",
			"主武器": "双联超重型破钢巨炮 (交替后坐力齐射)",
			"核心技能": "等离子核能耀斑爆震 (40% 概率全域扩散)",
			"威胁等级": "★★★★★★"
		},
		"desc": "平原与钢铁遗迹的陆行巨兽要塞。搭载四组独立履带与中央等离子聚变核心，旋转雷达可全方位索敌。主炮可轻易轰碎钢墙，核反应堆周期性向四周轰出超高温等离子冲击波与能量弹幕！",
		"tactics": "切勿在其正面直线停留！避开其等离子耀斑的能量环扩散半径，利用其缓慢转向的弱点在其侧面机动游走打击。"
	},
	{
		"id": "enemy_scorpion_boss",
		"category": "TANKS",
		"name": "沙漠机械巨蝎 (Desert Mech Scorpion)",
		"tag": "终极首领 / 仿生高机动",
		"icon": "res://assets/sprites/tanks/enemy_scorpion_boss_f0.png",
		"stats": {
			"生命值": "12~24 HP (多节仿生甲)",
			"移速": "82 px/s (六足高速突进)",
			"尾部武器": "多节毒刺高能穿透激光 (贯穿全图)",
			"双螯武器": "双前螯液压速射弹幕 (夹角扩散)",
			"威胁等级": "★★★★★★"
		},
		"desc": "沙漠荒原的仿生重甲巨型猎手。六足三角步态提供极高机动性，背部多节毒刺尾可越过障碍射出高能聚能激光，双前螯机械爪可同时向两侧倾泻交叉火力。",
		"tactics": "其毒刺激光射击前会有明显尾部充能前摇，必须保持横向高速机动规避直线激光。"
	},
	{
		"id": "enemy_mammoth_boss",
		"category": "TANKS",
		"name": "极地猛犸重装机甲 (Glacial Mammoth Mech)",
		"tag": "终极首领 / 极寒冰原霸主",
		"icon": "res://assets/sprites/tanks/enemy_mammoth_boss_f0.png",
		"stats": {
			"生命值": "18~35 HP (极寒永冻装甲)",
			"移速": "40 px/s (液压四足重步态)",
			"主武器": "双联极寒攻城重榴弹 (破钢弹)",
			"践踏技能": "极寒冰霜新星大践踏 (大范围冻结冰雾)",
			"威胁等级": "★★★★★★"
		},
		"desc": "冰封极地的巨型液压四足机甲。通体覆盖永冻冰晶与重型防弹装甲板，双联极寒榴弹炮威力毁天灭地，厚重机甲步态践踏地面时将激起大范围极寒冰霜新星，造成强烈冰爆冲击！",
		"tactics": "保持中远距离交火，猛犸机甲的近身冰霜新星具有极高压制力，切忌近身贴脸输出。"
	},
	...
	# =========================================================================
	{
		...
		"stats": {"获取效果": "主炮等级 +1 (最高可达等离子穿甲级)，同时战车等级 +1"},
		"desc": "经典战场能量强化之星。拾取后可逐步提升子弹飞行速度、连射数量并解锁等离子破钢能力，同时也是战役模式中战车升级的唯一途径 —— 没有经验条，只有吃星。",
		"tactics": "开局最重要的争夺物资，一旦出现应优先夺取；不仅决定主炮火力，也直接决定战车等级。"
	},
	{
		"id": "item_bomb",
		"category": "ITEMS",
	...
	},
	{
		"id": "item_piston",
		"category": "ITEMS",
		"name": "活塞冲压弹 (Piston Rounds)",
		"tag": "动能推移 / 挤压粉碎",
		"icon": "res://assets/sprites/powerups/piston_rounds.png",
		"stats": {"获取效果": "获得活塞冲压弹专长，主炮可推移墙体并触发挤压处决"},
		"desc": "重动能改装道具。拾取后使玩家主炮具备强悍推墙动能，将敌人挤压至死角可直接处决消灭！",
		"tactics": "利用推墙能力改换战区格局，利用两面夹击的挤压处决消灭高血量精英或首领。"
	},
	{
		"id": "item_iff_flag",
		"category": "ITEMS",
		"name": "友军标识旗 (Friendly IFF Banner)",
		"tag": "友军免伤 / 基地守护",
		"icon": "res://assets/sprites/powerups/iff_flag.png",
		"stats": {"获取效果": "部署友军识别标识旗 40 秒 (商店购买为整局永久)，我方炮火绝对豁免基地伤害"},
		"desc": "高悬于基地哨塔的友军识别标识旗（光环转为翡翠绿）。生效期间我方所有普通穿甲炮弹、高爆定时炸弹与动能推墙，均对基地完全免疫，绝不误伤自毁！但敌军火力仍会对基地造成正常伤害。",
		"tactics": "在战况混乱、敌我交织混战于基地周围时拾取，玩家即可肆无忌惮地朝基地方向扫射清怪，毫无误伤顾虑。"
	},
	...
	},
	{
		"id": "bld_bunker",
		"category": "BUILDINGS",
		"name": "战术防御堡垒 (Tactical Bunker)",
		"tag": "正面重盾 / 射击孔架枪 / 侧翼弱点",
		"icon": "res://assets/sprites/buildings/bunker.png",
		"stats": {
			"正面防御": "正面重型装甲格挡低阶炮弹 (免伤)",
			"射击孔机制": "从后方紧贴掩体射击可穿透射出",
			"侧翼生命": "6 HP (左右侧面/后方受击承受伤害并可被破坏)"
		},
		"desc": "配备正面厚重斜面装甲板与狭长射击孔的战术工事。坦克可躲在堡垒后方安全地向前方开火（子弹顺畅穿过射击孔出膛），正面能完全格挡来袭的低阶敌方炮弹；但左面和右面装甲薄弱，从侧翼射入的子弹会正常破坏该堡垒。",
		"tactics": "极佳的正面对线掩体！架设在关键狭窄隘口或要道前，坦克贴在后方安全输出，同时务必用障碍物或队友掩护其侧翼薄弱处。"
	},
	{
		"id": "bld_wooden_wall",
		"category": "BUILDINGS",
		"name": "可移动木墙 (Movable Wooden Wall)",
		"tag": "物理接触推移 / 撞击碾压 / 破片反击",
		"icon": "res://assets/sprites/buildings/wooden_wall.png",
		"stats": {
			"结构生命": "3 HP (3 个损伤视觉阶段)",
			"接触推移": "受到坦克物理撞击或子弹射击时沿受力方向滑行 1 格",
			"接触破坏": "撞击敌人造成 2 点撞击伤害与眩晕，可直接碾碎普通砖块与软陶泥",
			"破片爆炸": "本体彻底碎裂时向周围迸发木刺破片，造成 1 点范围震荡伤害"
		},
		"desc": "以坚固原木、斜拉木梁与锻铁箍带打造的重型便携木质防御墙。底部配备滑行木橇，坦克可通过直接推挤或向其开火来推动木墙滑行，利用其巨大动量碾碎沿途砖块并撞击敌方坦克；受到多次攻击或强烈冲击后将逐步开裂直至彻底崩解。",
		"tactics": "极具战术弹性的多功能工事！既可作为随时随地推移的移动掩体，也可作为'攻城木锤'主动推向敌群和障碍物进行碾压与突袭。"
	},
	{
		"id": "bld_darkness_device",
		"category": "BUILDINGS",
		"name": "灵能暗幕装置 (Darkness Shroud Device)",
		"tag": "全图黑夜遮蔽 / 自体光源 / 炮火光效",
		"icon": "res://assets/sprites/buildings/darkness_device.png",
		"stats": {
			"结构耐久": "5 HP (黑曜石黏土方尖碑)",
			"遮蔽效果": "部署后立即将全战场笼罩于浓密暗夜迷雾中",
			"自体照明": "装置核心自带紫光光晕 (半径 105px)",
			"战场照明": "玩家载具享有车灯微光，炮弹轨迹与爆炸闪光穿透夜幕",
			"驱散机制": "战场上所有暗幕装置被摧毁后，黑夜迷雾消散重现光明"
		},
		"desc": "由深渊黑曜石黏土与虚空水晶铸造的灵能吸光仪。部署后将强行展开遮天蔽日的暗幕力场，令整个战场陷入深邃黑暗之中。在暗幕笼罩下，仅装置自身核心、玩家战车微光、飞行中的弹道以及炮弹爆炸的刺目烈焰具备可视光源。",
		"tactics": "极具战术威慑力的环境控制装置！黑夜将彻底瓦解敌军的远距离集火阵型，配合玩家自身的移动车灯打出奇袭刺杀；利用炮火与爆炸的闪光短暂侦察敌方站位，摧毁装置即可瞬间让阳光重回战场。"
	},
	{
		"id": "bld_oil_barrel",
		"category": "BUILDINGS",
	...
	{
		"id": "tile_reinforced_steel",
		"category": "TERRAIN",
		"name": "特级强化钢墙 (Reinforced Steel Wall)",
		"tag": "全火力免疫 / 唯爆破可破",
		"icon": "res://assets/sprites/tiles/tile_steel.png",
		"stats": {"通行特性": "阻挡坦克、任何等级炮弹与激光", "破坏方式": "仅定时炸弹、地雷、导弹打击可破，油桶爆炸对其无效"},
		"desc": "比普通钢墙还要厚重的特级装甲板，就连破钢等级的三级炮弹与穿透激光都无法在其表面留下痕迹，只有威力最猛烈的几种爆破武器才炸得穿。",
		"tactics": "正面强攻打不动就是打不动，绕开它或者换上炸弹、地雷、导弹打击——普通炮弹和油桶再多也是徒劳。"
	},
	{
		"id": "tile_trees",
		"category": "TERRAIN",
