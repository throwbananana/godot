...
- **Known-unfixed:** ~16 assets (`tile_ice`, `icon_armor`, `icon_regen`, `icon_atk`, `icon_speed`, `treasure_key`, `treasure_chest`, `tile_hard_clay`, `tile_platform`, `tile_conveyor`, `tile_jump_pad`, `shield_station`, `wind_blower`, `node_challenge`, `diorama_shop`, `diorama_event`) still render differently from what is committed — silhouettes match but shading does not. Not yet diagnosed.
